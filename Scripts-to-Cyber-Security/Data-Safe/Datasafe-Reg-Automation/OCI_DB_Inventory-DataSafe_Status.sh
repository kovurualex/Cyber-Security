...
process_region() {
    ...
    if [ "$data_safe_status" == "NOT_REGISTERED" ]; then
        ...
        echo "${region:-NULL},${db_name:-NULL},${db_system_id:-NULL},${pdb_name:-NULL},${service_name:-NULL},${listener_port:-NULL},${compartment_name:-NULL},${compartment_id:-NULL},${connectivity_options:-NULL,NULL},DATASAFEUSER,PASSWORD123,${pdb_name:-NULL}" >> "$file8"
    fi
    done < <(tail -n +2 "$file4")
    ...
    if [ "$data_safe_status" == "NOT_REGISTERED" ]; then
        connectivity_options=$(map_connectivity_options "$vcn_name")
        service_name="${pdb_name}.${domain}"
        echo "${region:-NULL},${db_name:-NULL},${vm_cluster_id:-NULL},${pdb_name:-NULL},${service_name:-NULL},${listener_port:-NULL},${compartment_name:-NULL},${compartment_id:-NULL},${connectivity_options:-NULL,NULL},DATASAFEUSER,PASSWORD123,${pdb_name:-NULL}" >> "$file9"
    fi
    done < <(tail -n +2 "$file5")
    ...
    echo "$REGION_NAME,DBSEC19cLAB,pdb1,pdb1,1521,129.213.28.240;10.0.0.150,AlexKovuru,ocid1.compartment.oc1..aaaaaaaa7ksdb47smsqbyfn7pc2fd7qxmij3n2kisrutq5f3jmebtvjggjua,OC 202407121441,ocid1.datasafeonpremconnector.oc1.iad.amaaaaaas4n35viafiq42owokuttm5i2cy2sfnaqmxjviilbpq26fekvzona,DATASAFEADMIN,QAZxswedc123##,pdb1" >> "$file10"
